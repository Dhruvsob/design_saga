...
export default function PageHero({
  ...
  return (
    <div
      className="fade-up flex items-start justify-between flex-wrap gap-4 pb-6 border-b border-[#E8E6E1]"
      data-testid={testid}
    >
      <div className="min-w-0">
        ...
        <h1 className="font-display font-bold tracking-tighter text-3xl sm:text-4xl lg:text-5xl leading-[1] sm:leading-[0.95]">
          {title}
        </h1>
        {kicker && <p className="text-[#5C5C5C] mt-2 max-w-xl text-sm sm:text-base">{kicker}</p>}
      </div>
