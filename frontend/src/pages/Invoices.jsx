...
import { Plus, FilePdf, Trash, Eye } from "@phosphor-icons/react";
  ...
  return (
    <div className="space-y-6" data-testid={`${docType}s-page`}>
      <div className="flex items-end justify-between">
        ...
        <button onClick={() => setShowForm(!showForm)} className="btn-primary" data-testid={`new-${docType}-btn`}>
              ...
              <tr key={r.id} className="border-b border-[#F0F0F0] hover:bg-[#FAFAFA]" data-testid={`${docType}-row-${r.id}`}>
                ...
                <Td>
                  <div className="flex items-center gap-2">
                    <button onClick={() => setPreview(r)} className="text-[#002FA7]" title="Preview"><Eye size={16} /></button>
                    <button onClick={() => download(r.id)} className="text-[#002FA7]" title="PDF"><FilePdf size={16} /></button>
